...
export const routingComponents = [HomepageComponent, BuyPageComponent, SendPageComponent, SpendPagePayForDentalServicesComponent, SpendPageExchangesComponent, SpendPagePayAssuranceFeesComponent, NotFoundPageComponent];