...
var projectData = {
                                        ...
                                        $('.section-amount-to #active-crypto').unbind().on('change', async function () {
                                            ...
                                            if ($(this).val() == 'dcn-l1' || $(this).val() == 'dcn-l2') {
                                                if ($(this).val() == 'dcn-l1') {
                                                    ...
                                                    $('.balance-line .balance-value .max-amount').html('<span class="amount">'+dcn_balance.toLocaleString()+'</span> DCN2.0');
                                                    /*$('.spendable-dcn-amount').attr('data-value', dcn_balance);
        ...
        swap_page: async function () {
            ...
            setTimeout(async function() {
                ...
                $(document).on('change', 'select.current-to', function() {
                    var L2EthBalance = projectData.utils.fromWei(l2_eth_balance, 'ether');
                    if (parseFloat(L2EthBalance).countDecimals() > 10) {
                        L2EthBalance = parseFloat(L2EthBalance).toFixedNoRounding(10).toString();
                    }
                    ...
                    if ($('select.current-from').val() == 'eth-l1' && $(this).val() == 'dcn-l2') {
                        ...
                        $('.swapping-section .to-box .balance-line .balance-value').html('Balance: <span class="color-light-blue"><span class="amount">'+L2EthBalance+'</span> ETH2.0</span>');
                ...
                $(document).on('change', 'select.current-from', function() {
                    ...
                    switch($(this).val()) {
                        case 'dcn-l1':
                            ...
                            break;
                        case 'eth-l1':
                            var L1EthBalance = projectData.utils.fromWei(l1_eth_balance, 'ether');
                            if (parseFloat(L1EthBalance).countDecimals() > 10) {
                                L1EthBalance = parseFloat(L1EthBalance).toFixedNoRounding(10).toString();
                            }
                        ...
                        case 'eth-l2':
                            ...
                            $('.swapping-section .from-box .balance-line .balance-value').html('Balance: <span class="color-light-blue"><span class="amount">'+L2EthBalance+'</span> ETH2.0</span>');
                ...
                $('.switch-layers-btn a').click(function() {
                    ...
                    if ($('select.current-from').val() == 'eth-l1') {
                        $('select.current-from').html('<option value="dcn-l1">DCN</option><option value="eth-l1">ETH</option><option value="dcn-l2">DCN2.0</option><option value="eth-l2" selected>ETH2.0</option>');
                    } else if ($('select.current-from').val() == 'eth-l2') {
                        $('select.current-from').html('<option value="dcn-l1">DCN</option><option value="eth-l1" selected>ETH</option><option value="dcn-l2">DCN2.0</option><option value="eth-l2">ETH2.0</option>');
                    } else if ($('select.current-from').val() == 'dcn-l1') {
                        $('select.current-from').html('<option value="dcn-l1">DCN</option><option value="eth-l1">ETH</option><option value="dcn-l2" selected>DCN2.0</option><option value="eth-l2">ETH2.0</option>');
                    } else if ($('select.current-from').val() == 'dcn-l2') {
                        $('select.current-from').html('<option value="dcn-l1" selected>DCN</option><option value="eth-l1">ETH</option><option value="dcn-l2">DCN2.0</option><option value="eth-l2">ETH2.0</option>');
                    }
    ...
    general_logic: {
            ...
            async function proceedWithTxConfirmationPopupInitialization(txIcon, belowTxIconHtml, usdHtml) {
                ...
                web3_provider.eth.getBalance(global_state.account, function (error, eth_balance) {
                    ...
                    if (error) {
                        ...
                        var raw_eth_balance = eth_balance;
                        eth_balance = new Decimal(projectData.utils.fromWei(eth_balance));
                        ...
                        if (window.localStorage.getItem('keystore_file') != null) {
                            ...
                            $('.cached-keystore-file .confirm-transaction.keystore-file').click(function () {
                                ...
                                if (parseInt(raw_eth_balance) == 0) {
                                    basic.showAlert($('.translates-holder').attr('no-balance'), '', true);
                                    $('.transaction-confirmation-popup .on-change-result').html('');
                                } else if (eth_balance.lessThan(eth_fee_check)) {
        ...
        openL2InformationPopups: function(type) {
            basic.showDialog('<div class="popup-slider"><div class="single-slide"><div class="text-center"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img id="what-is-dcn" alt="What is DCN2.0"></figure><h2 class="fs-26 fs-xs-24 padding-top-15">What is DCN2.0?</h2><div class="fs-20 padding-bottom-50">DCN2.0 is the b(igg)est upgrade of Dentacoin so far! It allows you to send and receive DCN2.0 tokens faster and with much lower transaction costs. It also protects the value of DCN from high fluctuations.</div></div><div class="bottom-menu padding-top-10 padding-bottom-30 fs-20 fs-xs-16 calibri-bold"><a href="javascript:void(0);" class="how-to-get-and-use-dcn2"><span class="inline-block padding-right-15 fs-20 fs-xs-16">• How to get and use DCN2.0?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a><a href="javascript:void(0);" class="whats-with-dcn"><span class="inline-block padding-right-15 fs-20 fs-xs-16">• What’s with the original version of DCN?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a></div></div><div class="single-slide"><div class="text-center"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="assets/images/pop-up-img2.png" alt="What is DCN2.0"></figure><h2 class="fs-26 fs-xs-24 padding-top-15">How to get and use DCN2.0?</h2><div class="fs-20 padding-bottom-50">DCN2.0 tokens are received as rewards from Dentacoin tools (eg. for writing a review on Dentacoin Trusted Reviews or taking DentaVox surveys). You can use them for staking to increase your savings, for payments at partner dentists, or for covering your Dentacoin Assurance fees. You can also easily swap DCN to DCN2.0 right here in your wallet.</div></div><div class="bottom-menu padding-top-10 padding-bottom-30 fs-20 fs-xs-16 calibri-bold"><a href="javascript:void(0);" class="whats-with-dcn"><span class="inline-block padding-right-15 fs-20 fs-xs-16">• What’s with the original version of DCN?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a><a href="javascript:void(0);" class="what-is-dcn2"><span class="inline-block padding-right-15 fs-20 fs-xs-16">• What is DCN2.0?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a></div></div><div class="single-slide"><div class="text-center"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="assets/images/pop-up-img3.png" alt="What is DCN2.0"></figure><h2 class="fs-26 fs-xs-24 padding-top-15">What’s with the original version of DCN?</h2><div class="fs-20 padding-bottom-50">It is alive and flourishing :) But its main use case would be for trading on exchange platforms.</div></div><div class="bottom-menu padding-top-10 padding-bottom-30 calibri-bold"><a href="javascript:void(0);" class="what-is-dcn2">• <span class="inline-block padding-right-15 fs-20 fs-xs-16">What is DCN2.0?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a><a href="javascript:void(0);" class="how-to-get-and-use-dcn2"><span class="inline-block padding-right-15 fs-20 fs-xs-16">• How to get and use DCN2.0?</span><img src="assets/images/right-arrow.svg" class="width-100 max-width-20 inline-block-important" alt="Arrow icon"/></a></div></div></div>', 'l2-information-popup', true);
...
function submitTransactionToBlockchain(web3_provider, transactionType, function_abi, symbol, token_val, to, key, data) {
    console.log(web3_provider, transactionType, function_abi, symbol, token_val, to, key, data);
                        ...
                        generateKeystoreFile($('.custom-auth-popup .keystore-file-pass').val().trim(), function (public_key, keystore, private_key) {
                            ...
                            if (is_hybrid) {
                                ...
                                if (basic.getMobileOperatingSystem() == 'Android') {
                                    ...
                                    projectData.general_logic.hybridAppFileDownload(keystore_file_name + '-1', JSON.stringify(keystore), function () {
                                        console.log('Saved to: ' + cordova.file.applicationStorageDirectory);
                                        projectData.general_logic.hybridAppFileDownload(keystore_file_name + '-2', JSON.stringify(keystore), function () {
                                            //saving keystore file to App folder
                                            console.log('Saved to: ' + cordova.file.externalDataDirectory);
                                            projectData.general_logic.hybridAppFileDownload(keystore_file_name + '-3', JSON.stringify(keystore), function () {
                                                console.log('Saved to: ' + cordova.file.externalApplicationStorageDirectory);
                                            ...
                                            }, cordova.file.externalApplicationStorageDirectory, false);
                                        }, cordova.file.externalDataDirectory, false);
                                    }, cordova.file.applicationStorageDirectory, true);
                                } else if (basic.getMobileOperatingSystem() == 'iOS' || navigator.platform == 'MacIntel') {
