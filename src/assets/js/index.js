    ...
    if(typeof(web3) !== 'undefined' && web3.currentProvider.isMetaMask === true) {
        ...
        $(document).on('click', '#download-four', function() {
            ...
            if(basic.getMobileOperatingSystem() == 'iOS') {
                ...
                window.resolveLocalFileSystemURL(file_path, function (fileSystem) {
                    console.log(fileSystem, 'fileSystem');
                    fileSystem.getFile('test-file-name', {create: true, exclusive: true}, function (fileEntry) {
                        fileEntry.createWriter(function (fileWriter) {
                            fileWriter.onwriteend = function (e) {
                                console.log('onwriteend COMPLETED');
                            };
